...
namespace ImGui
{
    ...
    IMGUI_API void          End();
IMGUI_API bool          CustomSwitch(const char* label, bool* v);
IMGUI_API bool          CustomSlider(const char* label, float* v, float v_min, float v_max);
bool IsTouchImGuiView(double x, double y);
void * getImGuiWindow();
    // Child Windows
